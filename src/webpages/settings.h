...
<div class="d-grid gap-2">
<a class="btn btn-success" href="/settingsedit" role="button">Cofigure ESP</a>
<a class="btn btn-secondary" href="/configedit" role="button">Cofigure Inverter</a>
<a class="btn btn-warning" href="/reboot" role="button">Reboot</a>
<a class="btn btn-danger" href="/confirmreset" role="button">Reset ESP</a>
